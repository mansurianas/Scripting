...
function create_backup {
    ...
    backup_dir="/home/ubuntu/Scripting/challange/backups/backup_$timestamp"
    ...
    mkdir -p "$backup_dir"
         ...
         # Use rsync to copy files, excluding the backups directory
    rsync -a --exclude='backups/' "$1/" "$backup_dir/"
